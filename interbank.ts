...
class BancoProgram {
    private static readonly VALID_OPTIONS = new Set<number>([
    ...
    private wsOpcao: number = 0;
    private wsLimpa: string = ' '.repeat(50);
    private wsP: string = ' ';
    ...
    private opcaoIncorreta(): void {
        console.log("OPCAO INCORRETA < ENTER >");
        readlineSync.question('');
        console.clear();
    }

    private moveOpcao(): void {
